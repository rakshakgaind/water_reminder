package com.project.water_reminder.fragments
...
import com.project.water_reminder.MainActivity
import com.project.water_reminder.databinding.BottomSheetFragmentBinding
import com.project.water_reminder.helpers.AlarmHelper
import com.project.water_reminder.helpers.SqliteHelper
import com.project.water_reminder.utils.AppUtils
...
class BottomSheetFragment(val mCtx: Context) : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.radioNotificItervel.setOnCheckedChangeListener() { button, position ->
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (resultCode == Activity.RESULT_OK && requestCode == 999 ) {
            ...
            if (data!=null){
                if (data.getParcelableArrayExtra(RingtoneManager.EXTRA_RINGTONE_PICKED_URI)!=null){
